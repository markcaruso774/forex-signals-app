...
# === 7. MAIN APP ===
    ...
    # === COMPLETE ABOUT SECTION (Full Text) ===
    with st.expander("📖 User Guide & Telegram Setup"):
        st.markdown(
            """
            ### 🧙‍♂️ What is PipWizard?
            PipWizard is a professional tool to **backtest** and **automate** your forex trading.
            
            * **Free Tier:** Test any strategy on historical data & get EUR/USD alerts.
            * **Premium Tier:** Automatically scan all 12 pairs for profitable setups & get alerts for everything.
            ...
            * **SMA Crossover:** Similar to EMA but uses simple averages. Good for standard trend trading.
            * **MACD Crossover:** Buys when the MACD line crosses the Signal line. Good for catching momentum shifts.

            **2. Mean Reversion Strategies 🪀**
            * **Bollinger Bands Bounce:** Buys when price hits the Lower Band (cheap). Sells when price hits Upper Band (expensive). Best for sideways markets.
            * **RSI Standalone:** Buys when RSI < 30 (Oversold). Sells when RSI > 70 (Overbought).

            **3. Momentum & Scalping 🐇**
            * **Stochastic Oscillator:** Buys when momentum turns up from the bottom zone (<20). Faster than RSI.
            * **RSI + MACD Confluence:** Only trades when **BOTH** RSI and MACD agree. High accuracy, fewer trades.
            ...
            * **EMA Trend + Price Action:** The smartest strategy. It waits for an Uptrend (EMAs) **AND** a specific candle pattern (Pin Bar or Engulfing) before entering.
            ...
            2.  Click "Start". It will reply with your **ID** (e.g., `12345678`).
            3.  Copy that ID and paste it in the **Sidebar** on the left.
            4.  Click **"Save Settings"**.
            
            *(Note: You must also start a chat with our bot so it can message you).*
